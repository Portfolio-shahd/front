...
const projects: Project[] = [
  ...
  {
    id: 4,
    title: 'iNat WordPress Project',
    description: 'Développement d\'un site web WordPress personnalisé avec fonctionnalités avancées. Intégration de plugins personnalisés, optimisation SEO, et design responsive adapté aux besoins spécifiques du client.',
    category: 'Web Development',
    image: 'https://via.placeholder.com/400x300',
    link: '#',
  },
  {
    id: 5,
    title: 'BellaShop – Plateforme E-commerce',
    description: 'Développement d\'une plateforme e-commerce complète avec gestion des produits, panier d\'achat, système de paiement sécurisé, et interface d\'administration. Architecture moderne avec technologies web récentes.',
    category: 'Web Development',
    image: 'https://via.placeholder.com/400x300',
    link: '#',
  },
  {
    id: 6,
    title: 'ProCod – Plateforme de Développement',
    description: 'Développement d\'une plateforme collaborative pour développeurs incluant gestion de projets, partage de code, et outils de collaboration en temps réel. Interface moderne et intuitive pour améliorer la productivité des équipes.',
    category: 'Web Development',
    image: 'https://via.placeholder.com/400x300',
    link: '#',
  },
  {
    ...
    description: 'Création d\'un site web corporate moderne pour une entreprise spécialisée dans les solutions thermiques. Design professionnel, présentation des services, et interface optimisée pour la conversion client.',
    category: 'Web Development',
    image: 'https://via.placeholder.com/400x300',
    link: '#',
  },
